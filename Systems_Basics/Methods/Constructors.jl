#Shishir Khanal
#01/19/2023
#Constructors in Julia
#--------------------------
#mutable types provide flexibility but immutable types provide better performance
#Immutable types provide advatage for multithreading because there is no need for synchronization of 
#immutable objects between threads
#Do not put mutable fields inside immutable types if you care about performance
...
es2 = EconStudent("Daniel", 0, 3.2)
es3 = EconStudent("Daniel", 456789, 5)
es4 = EconStudent("Daniel", 123456, 3.2)
...
Julia01 = Course("Programming with Julia", [cs1, cs2, cs3, cs4, m1, es1])